...
class COCODataset(JointsDataset):
    ...
    def _get_ann_file_keypoint(self):
        ...
        # )
        return '/mnt/sda2/datasets/OCHuman/ochuman_coco_format_test_range_0.00_1.00.json'
        # return '/mnt/sda2/datasets/OCHuman/ochuman_coco_format_val_range_0.00_1.00.json'
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join('/mnt/sda2/datasets/OCHuman/images', file_name)
        return image_path
