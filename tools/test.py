...
from core.function import validate, validate_main_target
...
def parse_args():
    ...
    parser.add_argument('--detail-eval',
...
def main():
    ...
    # collate_fn_valid = collater(1, mode='window')
    # collate_fn_valid = collater(10, mode='window')
    # collate_fn_valid = collater(cfg.DATASET.MAX_PATCH, cfg.DATASET.PATCH_MODE)
    collate_fn_valid = collater(0, cfg.DATASET.PATCH_MODE)
    ...
    if cfg.DATASET.PATCH_MODE == 'main_target':
        validate_main_target(cfg, valid_loader, valid_dataset, model, criterion,
             final_output_dir, 0)
    else:
